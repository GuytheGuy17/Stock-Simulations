...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 22 13:41:12 2024
...
def delta_hedging(S0, K, T, r, sigma, paths, n, option_type="call"):
    ...
    :param n: Number of time steps
    :param option_type: 'call' or 'put'
    :return: Portfolio value and hedging error over time
    """
    dt = T / n
    S = np.zeros((paths, n))
    S[:, 0] = S0
    ...
    # Return results
    return portfolio_values, cash_positions, hedging_errors, S


# Parameters for delta hedging
paths = 1000
n = 252  # Daily time steps
portfolio_values, cash_positions, hedging_errors, simulated_prices = delta_hedging(
